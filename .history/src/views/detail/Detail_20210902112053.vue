	...
	methods: {
		...
		imgLoad() {
			...
			this.themeTopYs.push(
				0,
				paramsoffsetTop && paramsoffsetTop - this.$refs.nav.$el.offsetHeight,
				commentoffsetTop && commentoffsetTop - this.$refs.nav.$el.offsetHeight,
				recommendoffsetTop && recommendoffsetTop - this.$refs.nav.$el.offsetHeight,
				Infinity
			);
		},
		// 监听navbar点击
