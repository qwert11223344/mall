...
export default {
	...
	methods: {
		...
		imgLoad() {
			...
			const navoffsetHeight = this.$refs.nav.offsetHeight;
			this.themeTopYs.push(0);
			this.themeTopYs.push(this.$refs.params.$el.offsetTop - navoffsetHeight);
			this.themeTopYs.push(this.$refs.comment.$el.offsetTop - navoffsetHeight);
			this.themeTopYs.push(
				this.$refs.recommend.$el.offsetTop - navoffsetHeight
			);
