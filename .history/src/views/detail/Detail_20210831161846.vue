<template>
	<div class="detail">
		<detail-nav-bar />
		<scroll ref="scroll" class="wrapper" @scroll="currentPosition" :probe-type="3">
			<detail-swiper :top-images="topImages" ref="swiper" />
			<detail-base-info :goods="goods" />
			<detail-shop-info :shop="shop" />
			<detail-goods-info :detail-info="detailInfo" @imgLoad="imgLoad" ref="params" />
...
export default {
  ...
  methods:{
    ...
    imgLoad(){
      ...
      this.themeTopYs.push(0, this.$refs.params.$el.offsetTop, this.$refs.comment.$el.offsetTop, this.$refs.recommend.$el.offsetTop, Infinity)
      }
    },
		// 监听滚动
