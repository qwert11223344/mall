...
export default {
	...
	// 	titles(){
	// 		let titles = [];
	// 		if(Object.keys(this.topImages.length != 0)){
	// 			titles.push('商品');
	// 		}
	// 		if(Object.keys(this.paramsInfo.length != 0)){
	// 			titles.push('参数');
	// 		}
	...
	methods: {
		...
		imgLoad() {
			...
			this.$refs.params && (const paramsoffsetTop = this.$refs.params.$el.offsetTop);
			...
			this.$refs.params && this.themeTopYs.push(paramsoffsetTop - navoffsetHeight);
			this.$refs.comment && this.themeTopYs.push(commentoffsetTop - navoffsetHeight);
			this.$refs.recommend && this.themeTopYs.push(recommendoffsetTop - navoffsetHeight);
